...
{
	ImVec2 buttonSize = ImVec2 { m_WindowSize.x / 35.0f, 0.0f };

	ImGui::Text(" Vector 1: ");  ImGui::SameLine(m_WindowSize.x / 3.5f);
	ImGui::Text(" Vector 2: ");
	...
	ImGui::SameLine(m_WindowSize.x / 3.5f);

	ImGui::SetNextItemWidth(m_WindowSize.x / 4.0f); ImGui::DragFloat("##vec21", &vec2[0], 0.1f, 0.0f, 0.0f, "%.3f"); ImGui::SameLine(m_WindowSize.x / 1.867f);
	ImGui::PushStyleColor(ImGuiCol_Button, ImVec4 { 0.8f, 0.1f, 0.15f, 1.0f });
	ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4 { 0.9f, 0.2f, 0.2f, 1.0f });
	ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4 { 0.8f, 0.1f, 0.15f, 1.0f });
	ImGui::PushFont(m_OpenSansBold);
	...
	ImGui::SetNextItemWidth(m_WindowSize.x / 4.0f); ImGui::DragFloat("##vec12", &vec1[1], 0.1f, 0.0f, 0.0f, "%.3f"); ImGui::SameLine(m_WindowSize.x / 4.0f);
	...
	ImGui::SetNextItemWidth(m_WindowSize.x / 4.0f); ImGui::DragFloat("##vec22", &vec2[1], 0.1f, 0.0f, 0.0f, "%.3f"); ImGui::SameLine(m_WindowSize.x / 1.867f);
	ImGui::PushStyleColor(ImGuiCol_Button, ImVec4 { 0.f, 0.4f, 0.05f, 1.0f });
	ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4 { 0.1f, 0.5f, 0.15f, 1.0f });
	ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4 { 0.f, 0.4f, 0.05f, 1.0f });
	ImGui::PushFont(m_OpenSansBold);
	...
	ImGui::SetNextItemWidth(m_WindowSize.x / 4.0f); ImGui::DragFloat("##vec13", &vec1[2], 0.1f, 0.0f, 0.0f, "%.3f"); ImGui::SameLine(m_WindowSize.x / 4.0f);
	...
	ImGui::SetNextItemWidth(m_WindowSize.x / 4.0f); ImGui::DragFloat("##vec23", &vec2[2], 0.1f, 0.0f, 0.0f, "%.3f"); ImGui::SameLine(m_WindowSize.x / 1.867f);
	ImGui::PushStyleColor(ImGuiCol_Button, ImVec4 { 0.1f, 0.25f, 0.8f, 1.0f });
	ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4 { 0.2f, 0.35f, 0.9f, 1.0f });
	ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4 { 0.1f, 0.25f, 0.8f, 1.0f });
	ImGui::PushFont(m_OpenSansBold);
